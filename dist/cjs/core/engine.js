...
exports.AST_VERSION = exports.VERSION = void 0;
exports.sourceHash = sourceHash;
exports.createMixinEngine = createMixinEngine;
/*
...
function createMixinEngine(options) {
    ...
    if (options && options.acorn)
        (0, ast_js_1.setAcorn)(options.acorn);
        ...
        for (let mi = 0; mi < ordered.length; mi++) {
            ...
            for (let i = 0; i < mixins.length; i++) {
                ...
                if (mx.patches && mx.patches.length) {
                    const patched = (0, ast_js_1.applyAstPatches)(filename, out, mx.patches);
                    if (patched !== out)
                        out = patched;
                }
                if (out !== source) {
    ...
    function transform(filename, source) {
        ...
        const out = (0, ast_js_1.applyAstPatches)(filename, source, batch, stats);
    ...
    return {
        ...
        stats: function () { return { mods: mods.length, version: exports.VERSION }; },
